# eUI Icon Sets Reference

Consolidated icon list for all eUI 21 design system icon sets.
Source: https://eui.ecdevops.eu/eui-showcase-ux-components-21.x/showcase-design-system/design-tokens/icons
...
CSS import (in `angular.json` styles array):
```json
...
Usage:
```html
<span class="eui-flag-icon eui-flag-icon-be"></span>  <!-- Belgium -->
<span class="eui-flag-icon eui-flag-icon-fr"></span>  <!-- France -->
<span class="eui-flag-icon eui-flag-icon-de eui-flag-icon--rounded"></span>  <!-- Germany, rounded -->
```

Where `{iso}` is the lowercase 2-letter country code (be, fr, de, it, es, etc.).

Modifier: `eui-flag-icon--rounded` for rounded corners.

## Phosphor Regular (1512)
