...
### [Default](samples/eui-wizard-v2/Default)
...
- [Options: Custom icons](samples/eui-wizard-v2/custom-icons)
- [Options: indexLabel](samples/eui-wizard-v2/indexLabel)
- [Options: isShowStepTitle](samples/eui-wizard-v2/isShowStepTitle)
- [Main features: Remote navigation](samples/eui-wizard-v2/remote-navigation)
