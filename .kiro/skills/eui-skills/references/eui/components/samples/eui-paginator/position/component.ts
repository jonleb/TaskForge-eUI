...
export class PositionComponent implements OnInit, AfterViewInit {
    ...
    @ViewChild('paginatorMultipleTop') paginatorMultipleTop: EuiPaginatorComponent;
    @ViewChild('paginatorMultipleBottom') paginatorMultipleBottom: EuiPaginatorComponent;
