...
@Component({
    selector: 'selectable-row-all-pages',
    templateUrl: 'component.html',
    imports: [...EUI_ALERT, ...EUI_TABLE, EuiTemplateDirective, ...EUI_PAGINATOR, DecimalPipe],
})
export class SelectableRowAllPagesComponent {
    public data: Country[] = [
