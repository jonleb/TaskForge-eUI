...
import { EuiResizableDirective, EuiTemplateDirective } from '@eui/components/directives';

import { Country } from '../../models/eui-countries-response.model';

@Component({
    selector: 'cols-resizable',
    templateUrl: 'component.html',
    imports: [...EUI_ALERT, ...EUI_TABLE, EuiTemplateDirective, DecimalPipe, EuiResizableDirective, RouterModule],
})
export class ColsResizableComponent {
