...
@Component({
    ...
    selector: 'single-selectable-row',
    templateUrl: 'component.html',
    imports: [...EUI_ALERT, ...EUI_TABLE, EuiTemplateDirective, ...EUI_SLIDE_TOGGLE, ...EUI_PAGINATOR, DecimalPipe],
})
export class SingleSelectableRowComponent {
