...
@Component({
    selector: 'selectable-row-preselection',
    templateUrl: 'component.html',
    imports: [...EUI_TABLE, ...EUI_PAGINATOR, ...EUI_BUTTON, ...EUI_ALERT, EuiTemplateDirective, DecimalPipe],
})
export class SelectableRowPreselectionComponent {
    ...
    public preselectedRows: Country[] = [
        this.data[3],
        this.data[6],
        this.data[9],
        this.data[12],
