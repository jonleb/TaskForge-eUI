...
### [Default](samples/eui-discussion-thread/Default)

```html
<eui-discussion-thread titleLabel="Title" subTitleLabel="Sub title" [items]="messages" />
```
...
import { markFormGroupTouched, uniqueId, EuiGrowlService } from '@eui/core';
...
- [Main feature: Custom content](samples/eui-discussion-thread/content-template)
- [Misc: Dynamic items](samples/eui-discussion-thread/dynamic-items)
- [Misc: Modal content](samples/eui-discussion-thread/content-modal)
