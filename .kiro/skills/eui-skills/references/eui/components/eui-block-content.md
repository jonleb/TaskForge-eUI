...
### [Default](samples/eui-block-content/Default)
...
<code class="eui-u-text-code">eui-block-content</code> is a <code class="eui-u-text-code">div</code> wrapper that is announced to the screen reader users through <code class="eui-u-text-code">aria-label="eUI Block Content wrapper"</code>.<br>
