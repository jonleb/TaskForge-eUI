...
<p class="eui-u-text-paragraph">The <code class="eui-u-text-code">euiInputGroup</code> directive is used to easily gather and extend (multiple) form control(s) by adding text label, buttons, visual indicators, etc.
<br>
It can also be used to describe a group of options, provide guidance for making a selection or set the orientation of the form controls’ layout.</p>
...
| --- | --- |
| BaseStatesDirective | euiSizeS, euiSizeVariant |

## Samples

### [Default](samples/eui-input-group/Default)
...
- [Main features: Horizontal layout](samples/eui-input-group/Horizontal)
- [Main features: Required](samples/eui-input-group/Required)
- [Main features: Theming](samples/eui-input-group/theming)
- [Main features: Vertical layout (default)](samples/eui-input-group/Vertical)
- [Reactive Forms: Reactive Forms](samples/eui-input-group/Forms)
- [Reactive Forms: Reactive Forms validation](samples/eui-input-group/reactive-form-validation)
- [Reactive Forms: Template-Driven Forms](samples/eui-input-group/template-driven-form)
- [Composition: Group addons](samples/eui-input-group/group-addon)
- [Composition: Search field](samples/eui-input-group/search-field)
- [Misc: Advanced required](samples/eui-input-group/advanced-required)
- [Misc: Usage samples](samples/eui-input-group/usage)
