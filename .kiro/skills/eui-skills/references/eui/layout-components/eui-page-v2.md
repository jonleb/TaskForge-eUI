# layout components   eui page v2

```html
<eui-page>
    <eui-page-header>
        <eui-page-header-label>eui-page</eui-page-header-label>
        <eui-page-header-sub-label>Use the yellow button to access the page source code</eui-page-header-sub-label>
    </eui-page-header>
