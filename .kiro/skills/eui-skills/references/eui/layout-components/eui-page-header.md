...
- [Options: isCollapsible](samples/eui-page-header/collapsible)
- [Options: Label & subLabel](samples/eui-page-header/label-sublabel)
- [Main features: Action items](samples/eui-page-header/action-items)
- [Main features: Custom content](samples/eui-page-header/custom-content)
- [Misc: With eui-tooltip](samples/eui-page-header/with-tooltip)
