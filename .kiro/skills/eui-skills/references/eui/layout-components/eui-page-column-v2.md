    ...
    <tbody>
        <tr>
            ...
            <td>
                ...
                In such case, the <strong>eui-page-column-header</strong> is replaced by the <code class="eui-u-text-code">eui-page-column-header-start</code> and <code class="eui-u-text-code">eui-page-column-header-end</code> tags.
                <br>
...
| --- | --- |
| BaseStatesDirective | euiSizeS, euiSizeM, euiSizeL, euiSizeXL, euiSize2XL, euiSize3XL, euiSize4XL, euiSizeVariant, euiHighlighted |

## Samples

### [Default](samples/eui-page-column-v2/Default)
...
- [Variants: Sizes](samples/eui-page-column-v2/sizes)
- [Options: Autoclose on resize](samples/eui-page-column-v2/autoclose)
- [Options: isCollapsed with icons](samples/eui-page-column-v2/collapsed-with-icons)
- [Options: isCollapsed with initials](samples/eui-page-column-v2/collapsed-with-initials)
- [Options: isCollapsible](samples/eui-page-column-v2/collapsible)
- [Main features: Custom header & footer](samples/eui-page-column-v2/custom-header-footer)
