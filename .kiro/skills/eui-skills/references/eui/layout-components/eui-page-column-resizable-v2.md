# layout components   eui page column resizable v2

```html
<eui-page>
    <eui-page-header>
        <eui-page-header-label>eui-page-columns</eui-page-header-label>
        <eui-page-header-sub-label>with resizable columns</eui-page-header-sub-label>
    </eui-page-header>    
