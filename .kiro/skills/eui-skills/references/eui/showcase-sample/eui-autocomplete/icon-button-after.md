---
description: Places icons and buttons after the field using input-group addons.
id: icon-button-after
---
...
<div class="row">
    ...
    <div class="col-md-6">
        <div euiInputGroup>
            <div euiInputGroupAddOn>
                <eui-autocomplete [autocompleteData]="autocompleteData" />
                <button euiButton euiPrimary euiOutline euiIconButton type="button" aria-label="Search">
                    <eui-icon-svg icon="eui-search"/>
                </button>
            </div>
        </div>
...
export class IconButtonAfterComponent {
