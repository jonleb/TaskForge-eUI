---
description: Shows options rendered with icons (SVG and flag classes), with and without chips.
id: iconclass
---

```html
<div class="doc-sample-section-title">Using eUI icons</div>
<eui-autocomplete [autocompleteData]="autocompleteDataIcons" />

<div class="doc-sample-section-title">Using rounded Flag icons</div>
<eui-autocomplete [autocompleteData]="autocompleteData" />

<div class="doc-sample-section-title">Using eUI icons with chips</div>
<eui-autocomplete [autocompleteData]="autocompleteDataIcons" hasChips />

<div class="doc-sample-section-title">Using rounded Flag icons with chips</div>
