---
description: Demonstrates basic checkbox usage with euiInputCheckBox directive and label pairing, including checked/unchecked states, standalone checkboxes, table integration, dynamic creation, and horizontal vs vertical layout patterns using flexbox utilities.
id: Default
---
...
With label <eui-slide-toggle [isChecked]="hasLabel" (slideToggleChange)="onChange($event)" /><br/>
<br>
