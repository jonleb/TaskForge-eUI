---
description: Shows the comment thread inside a dialog with a dedicated footer textarea for posting new top-level comments.
id: in-dialog
---
            ...
            @for (comment of comments; track comment.id) {
                <eui-comment-item
                    ...
                    <eui-comment-item-right-actions>
                        <ng-container *ngTemplateOutlet="rightActions; context: { $implicit: comment.id }" />
                    </eui-comment-item-right-actions>
                    ...
                    @for (level2 of comment.children; track level2.id) {
                        <eui-comment-item
                            ...
                            <eui-comment-item-right-actions>
                                <ng-container *ngTemplateOutlet="rightActions; context: { $implicit: level2.id }" />
                            </eui-comment-item-right-actions>
                            ...
                            @for (level3 of level2.children; track level3.id) {
                                <eui-comment-item
                                    ...
                                    <eui-comment-item-right-actions>
                                        <ng-container *ngTemplateOutlet="rightActions; context: { $implicit: level3.id }" />
                                    </eui-comment-item-right-actions>
                                    ...
                                    @for (level4 of level3.children; track level4.id) {
                                        <eui-comment-item
                                            ...
                                            <eui-comment-item-right-actions>
                                                <ng-container *ngTemplateOutlet="rightActions; context: { $implicit: level4.id }" />
                                            </eui-comment-item-right-actions>
                                        </eui-comment-item>
                                    }
                                </eui-comment-item>
