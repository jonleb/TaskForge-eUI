---
description: Enable multiselect across a multi-level tree.
id: multiselect-default-multi-level
---

```html
<eui-tree [nodes]="treeData" isMultiselect (selectionChange)="onSelectionChange($event)" />
```
...
@Component({
    selector: 'multiselect-default-multi-level',
    templateUrl: 'component.html',
    imports: [...EUI_TREE],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MultiselectDefaultMultiLevelComponent {
