---
description: Enable recursive multiselect so selecting a node affects its children.
id: multiselect-recursive
---

```html
<eui-tree [nodes]="treeData" isMultiselect isRecursiveSelection (selectionChange)="onSelectionChange($event)" />
```
...
@Component({
    selector: 'multiselect-recursive',
    templateUrl: 'component.html',
    imports: [...EUI_TREE],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MultiselectRecursiveComponent {
