---
description: Triggers upload automatically when files are dropped into the drag area.
id: auto-upload
---

```html
<form [formGroup]="form" enctype="multipart/form-data">
    <eui-file-upload formControlName="image" [progress]="progress" (drop)="onDrop()" hasDragArea>
...
export class AutoUploadComponent implements OnInit, OnDestroy {
