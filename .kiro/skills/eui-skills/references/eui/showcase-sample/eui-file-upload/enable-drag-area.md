---
description: Enables drag-and-drop to select files in addition to the browse action.
id: enable-drag-area
---

```html
<form [formGroup]="form" enctype="multipart/form-data">
    <eui-file-upload formControlName="image" [progress]="progress" hasDragArea>
...
export class EnableDragAreaComponent implements OnInit, OnDestroy {
