---
description: Hides the reset action to prevent clearing the file list.
id: no-reset-button
---

```html
<form [formGroup]="form" enctype="multipart/form-data">
    <eui-file-upload formControlName="image" [progress]="progress" [hasResetButton]="false" hasDragArea>
...
export class NoResetButtonComponent implements OnInit, OnDestroy {
