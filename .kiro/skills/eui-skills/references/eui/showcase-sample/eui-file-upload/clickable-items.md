---
description: Emits itemClick events so uploaded entries can open a preview or details panel.
id: clickable-items
---

```html
<form [formGroup]="form" enctype="multipart/form-data">
    <eui-file-upload isItemsClickable formControlName="image" [progress]="progress" (itemClick)="onItemClick($event)">
