---
description: Restricts selectable files to a specific extension using the accept filter.
id: allowed-files
---

```html
<form [formGroup]="form" enctype="multipart/form-data">
    <eui-file-upload formControlName="image" [progress]="progress" [accept]="'.jpg'" hasDragArea>
...
export class AllowedFilesComponent implements OnInit, OnDestroy {
