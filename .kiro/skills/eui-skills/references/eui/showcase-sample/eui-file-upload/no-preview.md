---
description: Disables file previews so the upload list does not render thumbnails or icons.
id: no-preview
---

```html
<form [formGroup]="form" enctype="multipart/form-data">
    <eui-file-upload formControlName="image" [progress]="progress" [hasPreview]="false" hasDragArea>
...
export class NoPreviewComponent implements OnInit, OnDestroy {
