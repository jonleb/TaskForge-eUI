---
description: Programmatically set the initial page using the paginator API after view init.
id: page-start
---

```html
<eui-paginator #setPaginator
...
export class PageStartComponent implements AfterViewInit {
    ...
    readonly setPaginator = viewChild<EuiPaginatorComponent>('setPaginator');

    ngAfterViewInit(): void {
        this.setPaginator().getPage(2);
    }
