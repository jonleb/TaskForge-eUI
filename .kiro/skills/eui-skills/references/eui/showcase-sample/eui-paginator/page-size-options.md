---
description: Configure the current page size and the selectable page-size options.
id: page-size-options
---

```html
<eui-paginator [length]="dataSource.length" [pageSize]="pageSize" [pageSizeOptions]="pageSizeOptions" />
```
