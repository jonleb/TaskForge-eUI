---
description: Enable numbered page shortcuts between the previous and next controls.
id: page-numbering
---

```html
<eui-paginator [length]="dataSource.length" [pageSize]="5" [hasPageNumberNavigation]="true" />
```
...
@Component({
    selector: 'page-numbering',
    templateUrl: 'component.html',
    imports: [...EUI_PAGINATOR, ...EUI_ALERT],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class PageNumberingComponent {
