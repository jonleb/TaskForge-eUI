---
description: Renders the range selector in read-only mode to prevent edits.
id: read-only
---

```html
<eui-date-range-selector [isReadOnly]="true" [startDateDefaultValue]="startDate" [endDateDefaultValue]="endDate" />
```
