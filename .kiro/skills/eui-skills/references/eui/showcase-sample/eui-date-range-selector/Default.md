---
description: Basic date range selector, shown with empty inputs and with preset start/end values.
id: Default
---
...
<eui-date-range-selector [startDateDefaultValue]="startDate" [endDateDefaultValue]="endDate" />
```
