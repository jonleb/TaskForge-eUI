---
description: Sticky header and footer while scrolling the table body.
id: sticky-header-footer
---

```html
<div class="eui-table__scrollable-wrapper" style="height: 600px; overflow-y: auto;" tabindex="0">
    <table euiTable isTableResponsive hasStickyHeader hasStickyFooter [data]="data">
...
@Component({
    selector: 'sticky-header-footer',
    templateUrl: 'component.html',
    imports: [...EUI_TABLE, EuiTemplateDirective, DecimalPipe],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StickyHeaderFooterComponent {
