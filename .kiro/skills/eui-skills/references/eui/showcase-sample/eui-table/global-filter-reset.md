---
description: Programmatically resets the global filter input.
id: global-filter-reset
---

```html
<button euiButton (click)="resetFilter()">Reset filter manually</button><br/>
...
import { EUI_TABLE, EuiTableFilterComponent } from '@eui/components/eui-table';
...
@Component({
    selector: 'global-filter-reset',
    templateUrl: 'component.html',
    imports: [...EUI_TABLE, ...EUI_BUTTON, EuiTemplateDirective, ...EUI_PAGINATOR, DecimalPipe],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class GlobalFilterResetComponent {
    ...
    readonly filter = viewChild<EuiTableFilterComponent>('filter');
