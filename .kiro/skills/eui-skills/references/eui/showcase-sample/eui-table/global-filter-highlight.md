---
description: Highlights filter matches using the default highlight style.
id: global-filter-highlight
---
        ...
        <ng-template let-row euiTemplate="body">
            <tr>
                <td data-col-label="Country" nowrap>
                    ...
                    <span [innerHTML]="row.country | euiTableHighlight: strFilter"></span>
                </td>
                <td data-col-label="Year"><span [innerHTML]="row.year | euiTableHighlight: strFilter"></span></td>
                <td data-col-label="ISO"><span [innerHTML]="row.iso | euiTableHighlight: strFilter"></span></td>
                <td data-col-label="Population">
                    <span [innerHTML]="row.population | number | euiTableHighlight: strFilter"></span>
                </td>
                <td data-col-label="Capital city">
                    <span [innerHTML]="row.capital | euiTableHighlight: strFilter"></span>
                </td>
            </tr>
        </ng-template>
