# App development - Step 1 - Initialization

<!-- <b class="eui-u-color-success">Code commit for this page</b>

<a target="_blank" href="https://citnet.tech.ec.europa.eu/CITnet/stash/projects/CSDR/repos/app-eui-default/commits/eefcf208c6fe80a1422f192b1320fca709c25a22">eUI app default - initial setup commit link</a>
...
![first-commit-1](assets/docs/images/03-app-dev/01-init/first-commit-1.png)

In Bitbucket the repo has been correctly pushed : 

![first-commit-2](assets/docs/images/03-app-dev/01-init/first-commit-2.png)
...
![first-commit-3](assets/docs/images/03-app-dev/01-init/first-commit-3.png)

![first-commit-4](assets/docs/images/03-app-dev/01-init/first-commit-4.png)

Once the branch has been created, let's checkout develop in our local dev :

![first-commit-5](assets/docs/images/03-app-dev/01-init/first-commit-5.png)
