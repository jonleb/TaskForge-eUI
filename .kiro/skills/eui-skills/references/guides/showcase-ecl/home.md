...
<eui-page>
    <eui-page-content>
        <h2 class="ecl-u-type-heading-2 ecl-u-mv-none">Version support</h2>
        <p>Currently supported version of ECL is <strong>5.0.0-alpha.20*</strong></p>

        <h2 class="ecl-u-type-heading-2 ecl-u-mt-xl ecl-u-mb-none">Purpose</h2>
        ...
        <p class="ecl-u-type-paragraph ecl-u-mt-m ecl-u-mb-none">
            It is also possible to use all eUI components in eui/ECL application by importing specific component module or by importing all components pulling UxAllModule / EuiAllModule
        </p>
        ...
        <p class="ecl-u-type-paragraph ecl-u-mt-m ecl-u-mb-m">
            Documentation can be found as live showcase of all components available, as well as other building blocks, such as utility css classes, typography, colors etc.
        </p>
        ...
        <p>For support in building a European Commission website using the eui/ECL integration, please contact
            <a href="mailto:DIGIT-EUI-SUPPORT@ec.europa.eu">DIGIT eUI Support</a> team.
        </p>
        ...
        <br/>
        <small>* eUI is using valid ECL stylesheet, some angular support / features might be still under construction, please check component status badge for details</small>
