...
### [Default](samples/ecl-timeline/Default)

```html
<ecl-timeline>
    <ecl-timeline-item isHeadline>
        <div eclTimelineItemLabel>2025</div>
        <div eclTimelineItemTitle>Headline title</div>
...
- [Set of timelines](samples/ecl-timeline/set)
