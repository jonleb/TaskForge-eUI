...
### [Default](samples/ecl-media-container/Default)
...
- [Video example](samples/ecl-media-container/video-example)
- [Embedded video example](samples/ecl-media-container/embedded-video-example)
- [Infographic](samples/ecl-media-container/infographic)
