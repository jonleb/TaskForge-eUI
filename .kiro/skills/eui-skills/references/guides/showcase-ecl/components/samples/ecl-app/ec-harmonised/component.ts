...
@Component({
    ...
    imports: [TranslateModule, RouterLink, ...EUI_ECL_APP, ...EUI_ECL_BREADCRUMB, ...EUI_ECL_SITE_FOOTER, ...EUI_ECL_SITE_HEADER, ...EUI_ECL_ICON,
        ...EUI_ECL_LINK, ...EUI_ECL_PAGE_HEADER, ...EUI_ECL_MENU],
})
export class ECHarmonisedComponent {
    isLoggedIn = false;
