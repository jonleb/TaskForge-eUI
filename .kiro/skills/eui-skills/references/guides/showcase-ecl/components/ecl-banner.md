...
### [With picture](samples/ecl-banner/Default)
...
<ecl-banner copyright="Copyright or credit" [fontSize]="fontSize" [boxBackground]="boxBackground"
  ...
  <div eclBannerTitle id="banner-title-id">
  ...
  <a routerLink="/" eclLink variant="primary" isHighlight aria-describedby="banner-title-id">
...
- [Sizes](samples/ecl-banner/sizes)
- [With video](samples/ecl-banner/video)
