...
### [Default](samples/ecl-gallery/Default)
...
<ecl-gallery (share)="onShare($event)" (show)="onShow($event)" (hide)="onHide($event)"
    ...
    <ecl-gallery-item src="https://vod.prd.commavservices.eu/12/224712/LR_I224712EN1W.mp4" icon="video"
        ...
        mediaType="video">
        <video eclGalleryImage playsinline hasZoom poster="https://vod.prd.commavservices.eu/12/224712/THUMB_I224712EN1W_V_1.jpg"
...
- [No title on hover](samples/ecl-gallery/no-hover)
- [No Overlay](samples/ecl-gallery/no-overlay)
- [Grid display](samples/ecl-gallery/grid)
